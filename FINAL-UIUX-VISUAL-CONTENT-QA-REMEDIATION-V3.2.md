...
## V3.1 + PHASE-AWARE / RESPONSIVE-SCOPE / DOMAIN-ROLE CORRECTIONS
...
>
> Bắt buộc đọc `PHASE-AWARE-GATING.md`, Design Contract, Requirement Coverage Ledger và `docs/uiux/Phase-State.md`.
...
> **Core principle:** Final QA phải chặn lỗi thật trên scope thật; không được tạo blocker từ device, page role, OLD baseline hay release action không thuộc project hiện tại.
